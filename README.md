...
- หน้าร้านพร้อมภาพคาแรกเตอร์, pointer parallax, และสนามเล่นโมเดล 3D ด้วย Three.js ที่โหลดเมื่อเปิดใช้งาน
...
- `app/pet-scene.tsx`: โมเดล 3D แบบ procedural ไม่มีโมเดลหรือภาพจากเว็บอ้างอิง
